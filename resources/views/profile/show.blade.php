                            ...
                            <div class="col-md-10">
                                <div class="card">
                                    <div class="image-wrapper" style="text-align: center;">
                                        ...
                                        @elseif($randomImages && count($randomImages) > 0)
                                            <?php $randomImage = $randomImages[array_rand($randomImages)]; ?>
                                            <img src="{{ asset('img/' . basename($randomImage->getFilename())) }}" alt="ランダム画像" class="img-fluid" />
                                        @endif
                                    </div>
                                    <div class="card-body">
